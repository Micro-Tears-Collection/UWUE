...
public class MathUtils {
    ...
    public static float distance(Vector3D min1, Vector3D max1, Vector3D min2, Vector3D max2) {
        Vector3D c1 = new Vector3D();
        c1.add(min1); c1.add(max1); c1.div(2, 2, 2);
        
        Vector3D c2 = new Vector3D();
        c2.add(min2); c2.add(max2); c2.div(2, 2, 2);
        
        Vector3D d = new Vector3D();
        d.add(c1); d.sub(c2); d.mul(d);
        
        c1.set(max1); c1.sub(min1); c1.div(2, 2, 2);
        c2.set(max2); c2.sub(min2); c2.div(2, 2, 2);
        c1.mul(c1); c2.mul(c2);
