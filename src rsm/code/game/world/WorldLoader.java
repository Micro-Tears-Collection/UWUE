...
public class WorldLoader {
    ...
    public static void loadWorld(Game game, String map, 
		...
		if(lvl.groupExists("lighting")) {
			game.e3d.lightsData.setAmbient(StringTools.cutOnFloats(lvl.getDef("lighting", "ambient", "0"), ','));
		} else {
			game.e3d.lightsData.setAmbient(new float[]{1});
		}
    ...
    private static void loadObject(Game game, World world, String objType, String objName, IniFile ini, 
            float[] pos, ArrayList<Integer> sourcesToPlay) {
        //yeah...
        ...
        if(objType.equals("spr")) {
            ...
            game.e3d.lightsData.addLight(light);
        }
