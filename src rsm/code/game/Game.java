...
public class Game extends Screen {
    ...
    private void update() {
		...
		if(updateFrustum) world.setFlashlight(camPos, player.rotX, player.rotY);
    ...
    public void render() {
        ...
        world.render(e3d, main.hudRender, drawW, drawH);
		...
		/*main.hudRender.setSampling(true, false, false);
		main.hudRender.drawRect(e3d.shadowMap.fluxTex, 
				0, 0, 256, 256,
				0, 1, 1, 0,
				0xffffff, 1);
		main.hudRender.setDefaultSampling();*/
    ...
    public void keyPressed(int key) {
        ...
        if(!isPaused()) {
            if(Keys.isThatBinding(key, Player.INTERACT) && toActivate != null) {
                ...
                toActivate = null;
                tmp.activate(main);
            } else if(Keys.isThatBinding(key, Player.INTERACT)) updateFrustum ^= true;
